...
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('product') }}"><i class="nav-icon fad fa-tags"></i> Produits</a></li>
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('country-delivery') }}"><i class="la la-tag nav-icon"></i> Pays de livraison</a></li>
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('category') }}"><i class="la la-sitemap nav-icon"></i> Catégories</a></li>
...
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('setting') }}"><i class="la la-cog nav-icon"></i> Réglages</a></li>
