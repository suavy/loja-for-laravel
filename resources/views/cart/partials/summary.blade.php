<div class="cart-summary">
    ...
    @guest
        <div class="cart-summary__holder">
            <a href="#" class="button cart-summary-button cart-summary-button--checkout cart-summary-button--disabled">Paiement</a>
        </div>
        <div class="cart-summary__holder">
    ...
    @elseguest
        <div class="cart-summary__holder">
            <a href="#" class="button cart-summary-button cart-summary-button--checkout">Paiement</a>
        </div>
        <div class="cart-summary__holder">
